...
class RenderEngine {
  ...
  public function render($page){
    ...
    for ($i = 0; $i < count($result[0]); $i++) {
      ...
      } else if ($page->configuration->unset_variables_disappear) {
   ...
   */
  private function _read_template($page) {
